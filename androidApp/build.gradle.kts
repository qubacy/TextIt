...
android {
    ...
    compileOptions {
        sourceCompatibility = JavaVersion.toVersion(libs.versions.jvm.targetVersion.get())
        targetCompatibility = JavaVersion.toVersion(libs.versions.jvm.targetVersion.get())
    }
    buildFeatures {
        compose = true
    }
